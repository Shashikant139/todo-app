...
const TaskList: React.FC = () => {
  ...
  const handleChange =(index: number, event: React.ChangeEvent<HTMLInputElement>)=>{
    let value=[...inputFields];value[index].value= event.target.value;
    setInputFields(value)
  ...
  return (
    ...
    <div className="task_list_section">
      ...
      <div className="task_list_item"key={index}>
        ...
        <input type="text" title="input_text" className="text_input"  value={item.value} onChange={(event)=>{handleChange(index,event)}}/>
